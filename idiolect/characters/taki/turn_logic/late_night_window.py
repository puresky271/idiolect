...
def _set_topic_residue(sid: str) -> None:
    _RESIDUE_STATE.put(sid, {"trigger": "topic"})
...
def build_late_night_window_special_block(
    ...
    *,
    ...
    Args:
        ...
        ledger:    调用方传入的世界状态 dict，读 ledger["plans"]["立希"]["night_owl_today"]
    ...
    """
    if os.environ.get("TAKI_TURN_LOGIC_LATE_NIGHT_ENABLED", "1").strip() in ("0", "false", "False", "off", "no", ""):
        return ""
